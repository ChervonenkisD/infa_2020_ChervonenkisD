...
def Sabaka2(k, c, d, color, black1, white1, a):
    ...
    ellipse(screen, (color), ((-1) * (b + round(130 /a)) + 205 - round(40 * d/a), c - round(15/a), round(40 * d/a), round (10 * d/a))) #tail
...
def Sabaka1(b, c, d, color, black1, white1, a):
    ...
    ellipse(screen, (color), (b + round(130/a), c - round(15/a), round(40 * d/a), round (10*d/a))) #tail
